...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'D:/Programmes/wamp/www/MultimediaService/app/cache/prod/annotations', false);
    }
    protected function getAssetic_AssetManagerService()
    {
        $a = $this->get('templating.loader');
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('D:/Programmes/wamp/www/MultimediaService/app/cache/prod/assetic/config'), false)));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'projetindus', 'host' => '127.0.0.1', 'port' => NULL, 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driver' => 'pdo_mysql', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), $e, array());
    }
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        require_once 'D:/Programmes/wamp/www/MultimediaService/app/cache/prod/jms_diextra/doctrine/EntityManager_54882245064d3.php';
        $a = $this->get('annotation_reader');
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_65e5906c2dd5ce66968eb3e6ee170c97');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_65e5906c2dd5ce66968eb3e6ee170c97');
        $d = new \Doctrine\Common\Cache\ArrayCache();
        $d->setNamespace('sf2orm_default_65e5906c2dd5ce66968eb3e6ee170c97');
        ...
        $h->setProxyDir('D:/Programmes/wamp/www/MultimediaService/app/cache/prod/doctrine/orm/Proxies');
        ...
        return $this->services['doctrine.orm.default_entity_manager'] = new \EntityManager54882245064d3_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($i, $this);
    }
    ...
    {
        return $this->services['fos_rest.allowed_methods_loader'] = new \FOS\RestBundle\Response\AllowedMethodsLoader\AllowedMethodsRouterLoader($this->get('router'), 'D:/Programmes/wamp/www/MultimediaService/app/cache/prod/fos_rest', false);
    }
    ...
    protected function getJmsDiExtra_Metadata_MetadataFactoryService()
    {
        ...
        $instance->setCache(new \Metadata\Cache\FileCache('D:/Programmes/wamp/www/MultimediaService/app/cache/prod/jms_diextra/metadata'));
        return $instance;
    }
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('D:/Programmes/wamp/www/MultimediaService/app/logs/prod.log', 100, true);
    }
    ...
    protected function getSecurity_Access_DecisionManagerService()
    {
        ...
        $a->setCacheDir('D:/Programmes/wamp/www/MultimediaService/app/cache/prod/jms_security/expressions');
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('D:/Programmes/wamp/www/MultimediaService/app/cache/prod/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('D:/Programmes/wamp/www/MultimediaService/app/cache/prod/sessions');
    }
    protected function getSession_Storage_FilesystemService()
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('D:/Programmes/wamp/www/MultimediaService/app/cache/prod/sessions');
    }
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('exception_controller' => 'FOS\\RestBundle\\Controller\\ExceptionController::showAction', 'debug' => false, 'strict_variables' => false, 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => 'D:/Programmes/wamp/www/MultimediaService/app/cache/prod/twig', 'charset' => 'UTF-8', 'paths' => array()));
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'D:/Programmes/wamp/www/MultimediaService/app/../web', false);
    }
    ...
    protected function getJmsSerializer_MetadataFactoryService()
    {
        ...
        $instance->setCache(new \Metadata\Cache\FileCache('D:/Programmes/wamp/www/MultimediaService/app/cache/prod/serializer'));
        return $instance;
    }
    ...
    {
        $this->services['security.extra.metadata_factory'] = $instance = new \Metadata\MetadataFactory(new \Metadata\Driver\LazyLoadingDriver($this, 'security.extra.metadata_driver'), new \Metadata\Cache\FileCache('D:/Programmes/wamp/www/MultimediaService/app/cache/prod/jms_security', false));
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'D:/Programmes/wamp/www/MultimediaService/app/cache/prod');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => false,
            'kernel.name' => 'ap_',
            'kernel.cache_dir' => 'D:/Programmes/wamp/www/MultimediaService/app/cache/prod',
            ...
            'session.save_path' => 'D:/Programmes/wamp/www/MultimediaService/app/cache/prod/sessions',
            ...
            'router.resource' => 'D:/Programmes/wamp/www/MultimediaService/app/config/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'D:/Programmes/wamp/www/MultimediaService/app/cache/prod/twig',
                'charset' => 'UTF-8',
                'paths' => array(
                ),
            ),
            ...
            'swiftmailer.spool.default.memory.path' => 'D:/Programmes/wamp/www/MultimediaService/app/cache/prod/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'D:/Programmes/wamp/www/MultimediaService/app/cache/prod/assetic',
            ...
            'doctrine.orm.proxy_dir' => 'D:/Programmes/wamp/www/MultimediaService/app/cache/prod/doctrine/orm/Proxies',
            ...
            'jms_aop.cache_dir' => 'D:/Programmes/wamp/www/MultimediaService/app/cache/prod/jms_aop',
            ...
            'jms_di_extra.cache_dir' => 'D:/Programmes/wamp/www/MultimediaService/app/cache/prod/jms_diextra',
            'jms_di_extra.disable_grep' => false,
            'jms_di_extra.doctrine_integration' => true,
            'jms_di_extra.cache_warmer.controller_file_blacklist' => array(
            ),
            'jms_di_extra.doctrine_integration.entity_manager.file' => 'D:/Programmes/wamp/www/MultimediaService/app/cache/prod/jms_diextra/doctrine/EntityManager_54882245064d3.php',
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EntityManager54882245064d3_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
            ...
            'security.extra.cache_dir' => 'D:/Programmes/wamp/www/MultimediaService/app/cache/prod/jms_security',
            ...
            'fos_rest.cache_dir' => 'D:/Programmes/wamp/www/MultimediaService/app/cache/prod/fos_rest',
